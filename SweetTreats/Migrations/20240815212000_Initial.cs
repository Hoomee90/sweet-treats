    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SweetFlavorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    SweetId = table.Column<int>(type: "int", nullable: false),
                    FlavorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SweetFlavors", x => x.SweetFlavorId);
                    table.ForeignKey(
                        name: "FK_SweetFlavors_Flavors_FlavorId",
                        column: x => x.FlavorId,
                        principalTable: "Flavors",
                        principalColumn: "FlavorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SweetFlavors_Sweets_SweetId",
                        column: x => x.SweetId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SweetFlavors_FlavorId",
                table: "SweetFlavors",
                column: "FlavorId");

            migrationBuilder.CreateIndex(
                name: "IX_SweetFlavors_SweetId",
                table: "SweetFlavors",
                column: "SweetId");
